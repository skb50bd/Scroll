    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTimeOffset(new DateTime(2023, 4, 17, 1, 52, 44, 920, DateTimeKind.Unspecified).AddTicks(4080), new TimeSpan(0, 6, 0, 0, 0)), 10, "If you need to get even with someone you love, the impossible to open frustration box is just what you need.", 0, "abc-xyz.webp", "https://mynextdig.com/1", 17.99m, "The Impossible To Open Frustration Box" },
                    { 2, new DateTimeOffset(new DateTime(2023, 4, 17, 1, 52, 44, 922, DateTimeKind.Unspecified).AddTicks(2700), new TimeSpan(0, 6, 0, 0, 0)), 3, "Nothing will embarrass your poor unsuspecting victim quite like receiving one of these prank mail packages at their place or work.", 0, "abc-xyz.webp", "https://mynextdig.com/2", 11.86m, "Prank Mail Packages" },
                    { 3, new DateTimeOffset(new DateTime(2023, 4, 17, 1, 52, 44, 922, DateTimeKind.Unspecified).AddTicks(2800), new TimeSpan(0, 6, 0, 0, 0)), 69, "Ensure your buddy has nightmares for years to come by sending him 1500 live ladybugs.", 0, "abc-xyz.webp", "https://mynextdig.com/3", 30.96m, "1500 Live Ladybugs" },
                    { 4, new DateTimeOffset(new DateTime(2023, 4, 17, 1, 52, 44, 922, DateTimeKind.Unspecified).AddTicks(2810), new TimeSpan(0, 6, 0, 0, 0)), 3, "Gamers rejoice! Ensure no good game slips under your nose by playing everything on the 100 Video Games Bucket List poster.", 0, "abc-xyz.webp", "https://mynextdig.com/4", 17.47m, "100 Must Play Video Games Scratch Off Poster" },
                    { 5, new DateTimeOffset(new DateTime(2023, 4, 17, 1, 52, 44, 922, DateTimeKind.Unspecified).AddTicks(2830), new TimeSpan(0, 6, 0, 0, 0)), 1, "For both streamers and gamers, this backlit LED is the perfect way to give a customized gift to any gamer.", 0, "abc-xyz.webp", "https://mynextdig.com/5", 58.49m, "Personalized Gamertag Backlit LED" },
                    { 6, new DateTimeOffset(new DateTime(2023, 4, 17, 1, 52, 44, 922, DateTimeKind.Unspecified).AddTicks(2840), new TimeSpan(0, 6, 0, 0, 0)), 4, "After an intense gaming session getting pwned by kids half your age, you need a way to relax and calm your nerves.", 0, "abc-xyz.webp", "https://mynextdig.com/6", 7.96m, "Video Game Rage Candle" },
                    { 7, new DateTimeOffset(new DateTime(2023, 4, 17, 1, 52, 44, 922, DateTimeKind.Unspecified).AddTicks(2850), new TimeSpan(0, 6, 0, 0, 0)), 420, "Take the rainbow with a photography prism.", 0, "abc-xyz.webp", "https://mynextdig.com/7", 16.49m, "Photography Prism" }
                });
